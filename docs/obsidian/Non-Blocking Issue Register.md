...
| Dependencies | Repository-side P2.15 complete; PR #1 merged, all three required checks green, local 185/185 tests/typecheck/build passed. Manual Security Audit run 35286130474 detected 5 critical/21 high/15 moderate findings. [[Dependency Advisory Triage 2026-09-18]] records ENGGP repository maintainer ownership and approved deadlines. | Known advisories remain unresolved; Renovate activation and controlled update/security PR evidence are deferred. Overall P2.15 remains open. | Follow [[Dependency Automation]] for rollout evidence. D1/D2 due 2026-09-21, D3/D5 due 2026-09-25, D4 due 2026-10-02. Dependency upgrades require separate review. |
